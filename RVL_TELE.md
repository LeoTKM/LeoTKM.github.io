...
<div style="margin-bottom:10px"></div>
I independently developed the entire end-to-end project including CAD design (Fusion & Onshape), implementation of the ROS 2 software stack for low-level Dynamixel servo communication, gravity compensation, a FastAPI interface for sending commands to the follower system, and URDF modeling with accurate mass distribution and inertia properties.
